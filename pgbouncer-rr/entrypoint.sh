...
# Config file is in ÒiniÓ format. Section names are between Ò[Ó and Ò]Ó.
# Lines starting with Ò;Ó or Ò#Ó are taken as comments and ignored.
# The characters Ò;Ó and Ò#Ó are not recognized when they appear later in the line.
  printf "\
################## Auto generated ##################
[databases]
